...
class MaterialsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle bodyStyle = AppTextStyles.bodyLarge(context).copyWith(
      color:
          Color.lerp(palette.primary, Colors.black, 0.38) ??
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: metrics.gap(1.0)),
                            Text(
                              'Malzeme kartları, spesifikasyonlar ve tedarik bilgileri üzerinde çalışılıyor.',
                              style: bodyStyle,
                              textAlign: TextAlign.center,
                            ),
